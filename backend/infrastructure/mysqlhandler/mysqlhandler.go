...
// Execute performs a statement on the handler
func (h *Handler) Execute(ctx context.Context, stmt string) (Result, error) {
	results, err := h.Conn.ExecContext(ctx, stmt)
	return Result{results}, err
}

// Query performs a query on the handler
func (h *Handler) Query(ctx context.Context, stmt string, args ...interface{}) (Row, error) {
